...
const OwnerPanel = React.lazy(() => import('./OwnerPanel'));
const AccessLimitationModal = React.lazy(() => import('./AccessLimitationModal'));
const PaymentModal = React.lazy(() => import('./PaymentModal'));
const PaymentPage = React.lazy(() => import('./PaymentPage'));
const SubscriptionExpirationNotification = React.lazy(() => import('./SubscriptionExpirationNotification'));
const CashFlowUnlockRequest = React.lazy(() => import('./CashFlowUnlockRequest'));
const LicenseKeyInput = React.lazy(() => import('./LicenseKeyInput'));
const SubscriptionActivation = React.lazy(() => import('./SubscriptionActivation'));
...
function ClientDashboard({ onBackToLogin }: ClientDashboardProps) {
  ...
  // Carregar/sincronizar configurações da empresa (para refletir mudanças do OwnerPanel)
  useEffect(() => {
